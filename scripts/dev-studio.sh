...
wait_for_http "Python Audio Service" "http://127.0.0.1:8101/health" "$LOG_DIR/python-audio.log" 20
wait_for_http "Python AI Service" "http://127.0.0.1:8102/health" "$LOG_DIR/python-ai.log" 20
