...
export const Route = createFileRoute("/opencut-sandbox")({
  component: OpenCutSandboxPage,
});

export default function OpenCutSandboxPage() {
  ...
  const logMessage = (msg: string) => {
    setConsoleLogs(prev => [...prev, `[OpenCut Engine] ${msg}`]);
  };
  ...
  const handleUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    formData.append("projectId", "opencut-project-dev");
  ...
  const letGeminiDirect = async () => {
    ...
    setDirecting(true);
    logMessage(`Contacting live Gemini model to evaluate OpenCut capability contract...`);
  ...
  const runRealEdits = async () => {
    if (!fileId) return;
    setEditing(true);
    logMessage(`Triggering real server-side engine render for OpenCut pipeline...`);
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-white flex items-center gap-3">
              ...
              OpenCut Dedicated Engine Sandbox
            </h1>
        ...
        <div className="lg:col-span-1 space-y-6">
          <Card className="bg-slate-900 border-slate-800 text-slate-100">
            <CardHeader>
              ...
              <CardDescription>Upload footage directly into OpenCut workspace.</CardDescription>
            </CardHeader>
            <CardContent>
              <input
                type="file"
          ...
          <Card className="bg-slate-900 border-slate-800 text-slate-100">
            <CardHeader>
              ...
              <CardDescription>Direct OpenCut using natural language.</CardDescription>
            </CardHeader>
