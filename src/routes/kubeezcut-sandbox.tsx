...
export const Route = createFileRoute("/kubeezcut-sandbox")({
  component: KubeezCutSandboxPage,
});

export default function KubeezCutSandboxPage() {
  ...
  const logMessage = (msg: string) => {
    setConsoleLogs(prev => [...prev, `[KubeezCut Engine] ${msg}`]);
  };
  ...
  const handleUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      logMessage(`Probing media client-side...`);
      ...
      formData.append("projectId", "kubeezcut-project-dev");
  ...
  const letGeminiDirect = async () => {
    ...
    setDirecting(true);
    logMessage(`Contacting live Gemini model to evaluate KubeezCut capability contract...`);
  ...
  const runRealEdits = async () => {
    if (!fileId) return;
    setEditing(true);
    logMessage(`Triggering real server-side engine render for KubeezCut pipeline...`);
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-white flex items-center gap-3">
              ...
              KubeezCut Dedicated Engine Sandbox
            </h1>
        ...
        <div className="lg:col-span-1 space-y-6">
          <Card className="bg-slate-900 border-slate-800 text-slate-100">
            <CardHeader>
              ...
              <CardDescription>Upload footage directly into KubeezCut workspace.</CardDescription>
            </CardHeader>
            <CardContent>
              <input
                type="file"
          ...
          <Card className="bg-slate-900 border-slate-800 text-slate-100">
            <CardHeader>
              ...
              <CardDescription>Direct KubeezCut using natural language.</CardDescription>
            </CardHeader>
