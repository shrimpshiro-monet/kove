...
export interface ProjectState {
  ...
  updateClipBlendMode: (
    clipId: string,
    blendMode: import("@kove/core").BlendMode,
  ) => boolean;
  ...
  updateClipEmphasisAnimation: (
    clipId: string,
    emphasisAnimation: import("@kove/core").EmphasisAnimation,
  ) => boolean;
  ...
  addSubtitle: (subtitle: import("@kove/core").Subtitle) => Promise<void>;
  removeSubtitle: (subtitleId: string) => void;
  updateSubtitle: (
    subtitleId: string,
    updates: Partial<import("@kove/core").Subtitle>,
  ) => void;
  getSubtitle: (
    subtitleId: string,
  ) => import("@kove/core").Subtitle | undefined;
  importSRT: (
    srtContent: string
  ...
  updateMarker: (
    markerId: string,
    updates: Partial<import("@kove/core").Marker>,
  ) => void;
  getMarker: (markerId: string) => import("@kove/core").Marker | undefined;
  getMarkers: () => import("@kove/core").Marker[];
  ...
  updateSVGClip: (
    ...
    updates: {
      ...
      duration?: number;
      transform?: Partial<Transform>;
      entryAnimation?: import("@kove/core").GraphicAnimation;
      exitAnimation?: import("@kove/core").GraphicAnimation;
      colorStyle?: import("@kove/core").SVGColorStyle;
    },
  ) => SVGClip | null;
  ...
  subscribeWithSelector((set, get) => {
    ...
    return {
      ...
      addMarker: (time, label = "Marker", color = "#3b82f6") => {
        const newMarker: import("@kove/core").Marker = {
