...
import { Slider } from "@kove/ui";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
} from "@kove/ui/components/popover";
import { useEngineStore } from "../../../stores/engine-store";
import { useProjectStore } from "../../../stores/project-store";
import type { AdjustmentLayer, BlendMode, Effect } from "@kove/core";
...
export const AdjustmentLayerSection: React.FC<AdjustmentLayerSectionProps> = ({
  ...
  const [adjustmentLayerEngine, setAdjustmentLayerEngine] =
    useState<import("@kove/core").AdjustmentLayerEngine | null>(null);
